"""
This script is called by the plugin-wrapper, PetriNetClassify.js, which passes down the
...
from PetriNetClassify import PetriNetClassify
...
plugin = PetriNetClassify(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
